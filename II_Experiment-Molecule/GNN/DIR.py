...
def main():
    ...
    parser.add_argument('--datadir', default='data/Lipophilicity', type=str, help='directory for datasets.')
    ...
    for attribute_name in available_attributes:
        ...
        exp_dir = osp.join('DIR_results/Lipophilicity', experiment_name)
        ...
        for seed in args.seed:
            ...
            for epoch in range(args.epoch):
                ...
                logger.info(
                    ...
                    f"Spurious_Loss: {avg_spurious_loss:.6f}"
                )
